...
1. Bug fix for note cross contamination
2. Improved Kanban experience. 
3. Fixed a bug that stopped the creation of Welcome.md for new users.
4. Option to remove folder icons in the settings.
5. Improving copy and pasting experience on the clipboard. 
...
- [x] Copy and paste doesn't seem to be working
