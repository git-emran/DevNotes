...
## [What is RADIO about?](https://www.greatfrontend.com/front-end-system-design-playbook/framework#what-is-radio-about)
...
## [Using RADIO framework in interviews](https://www.greatfrontend.com/front-end-system-design-playbook/framework#using-radio-framework-in-interviews)
...
## [Requirements exploration](https://www.greatfrontend.com/front-end-system-design-playbook/framework#requirements-exploration)
...
### [What are the functional requirements and non-functional requirements?](https://www.greatfrontend.com/front-end-system-design-playbook/framework#what-are-the-functional-requirements-and-non-functional-requirements)
...
### [What are the core features to focus on and which are good-to-have?](https://www.greatfrontend.com/front-end-system-design-playbook/framework#what-are-the-core-features-to-focus-on-and-which-are-good-to-have)
...
### [Other possible questions](https://www.greatfrontend.com/front-end-system-design-playbook/framework#other-possible-questions)
...
## [Architecture / high-level design](https://www.greatfrontend.com/front-end-system-design-playbook/framework#architecture--high-level-design)
...
### [Typical components/modules](https://www.greatfrontend.com/front-end-system-design-playbook/framework#typical-componentsmodules)
...
## [Data model](https://www.greatfrontend.com/front-end-system-design-playbook/framework#data-model)
...
### [Server-originated data](https://www.greatfrontend.com/front-end-system-design-playbook/framework#server-originated-data)
...
### [Client-only data](https://www.greatfrontend.com/front-end-system-design-playbook/framework#client-only-data)
...
## [Interface definition (API)](https://www.greatfrontend.com/front-end-system-design-playbook/framework#interface-definition-api)
...
### [Server-client communication](https://www.greatfrontend.com/front-end-system-design-playbook/framework#server-client-communication)
...
Using the [News Feed system design](https://www.greatfrontend.com/questions/system-design/news-feed-facebook) example, the server provides a RESTful HTTP API that allows clients to fetch the latest feed posts.
...
### [Inter-client communication](https://www.greatfrontend.com/front-end-system-design-playbook/framework#inter-client-communication)
...
### [UI components API design](https://www.greatfrontend.com/front-end-system-design-playbook/framework#ui-components-api-design)
...
In interviews, unless you are asked to design a component (e.g. [Autocomplete](https://www.greatfrontend.com/questions/system-design/autocomplete), [Modal dialog](https://www.greatfrontend.com/questions/system-design/modal-dialog), [Dropdown Menu](https://www.greatfrontend.com/questions/system-design/dropdown-menu)) or a component makes up the main part of the product (e.g. [Pinterest's masonry grid](https://www.greatfrontend.com/questions/system-design/pinterest), a fairly complex component), you shouldn't need to spend time on component API design.

---

## [Optimizations and deep dive](https://www.greatfrontend.com/front-end-system-design-playbook/framework#optimizations-and-deep-dive)
...
### [General optimization / deep dive areas](https://www.greatfrontend.com/front-end-system-design-playbook/framework#general-optimization--deep-dive-areas)
...
### [Choosing topics](https://www.greatfrontend.com/front-end-system-design-playbook/framework#choosing-topics)
...
### [Exceptions](https://www.greatfrontend.com/front-end-system-design-playbook/framework#exceptions)
